...
(async () => {
  ...
  await fs.writeFile("cancer-comorbidities-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("cancer-comorbidities-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
